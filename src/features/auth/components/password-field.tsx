    ...
    return (
      <div className="space-y-2">
        ...
        <div className="relative">
          <input
            className={cn(
              "flex h-10 w-full rounded-lg border bg-background px-3 py-2 pr-10 text-sm text-foreground outline-none transition-colors duration-fast ease-standard placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring motion-reduce:transition-none",
              error
